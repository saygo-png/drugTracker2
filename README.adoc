...
[WARNING]
====
I'm inexperienced as a developer.
...
Some medications require precise timing to be safe. Relying fully on this program is dangerous.
====
...
environment.systemPackages = [
  inputs.drugtracker2.packages.${pkgs.stdenv.hostPlatform.system}.drug
];
```
